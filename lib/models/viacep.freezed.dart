...
/// Adds pattern-matching-related methods to [Viacep].
extension ViacepPatterns on Viacep {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Viacep value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Viacep() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Viacep value)  $default,){
final _that = this;
switch (_that) {
case _Viacep():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Viacep value)?  $default,){
final _that = this;
switch (_that) {
case _Viacep() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String cep,  String logradouro,  String bairro,  String localidade,  String uf,  String ibge)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Viacep() when $default != null:
return $default(_that.cep,_that.logradouro,_that.bairro,_that.localidade,_that.uf,_that.ibge);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String cep,  String logradouro,  String bairro,  String localidade,  String uf,  String ibge)  $default,) {final _that = this;
switch (_that) {
case _Viacep():
return $default(_that.cep,_that.logradouro,_that.bairro,_that.localidade,_that.uf,_that.ibge);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String cep,  String logradouro,  String bairro,  String localidade,  String uf,  String ibge)?  $default,) {final _that = this;
switch (_that) {
case _Viacep() when $default != null:
return $default(_that.cep,_that.logradouro,_that.bairro,_that.localidade,_that.uf,_that.ibge);case _:
  return null;
